...
class DropDown_4{
  ...
  Widget getDropDown(context,parent){
    ...
    return Container(
      ...
      child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection(parent.mainDropDown.d3.title ).where("cityID",isEqualTo:parent.mainDropDown.d2.name ).snapshots(),
  ...
  initDropDown( QuerySnapshot data  ){
    ...
    ls.add( DropdownMenuItem(child: Text('Select Towns') ,value: '0',));
